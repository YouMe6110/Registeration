...
public class RankListAdapter extends BaseAdapter {
    ...
    //생성자 만들어주기 (Constructor)
    public RankListAdapter(Context context, List<Course> courseList, Fragment parent) {//시간표를 위해 코드 추가(자신을 불러낸 부모 fragment를 담을 수 있도록 하기)
    ...
    @Override
    public View getView(final int i, View view, ViewGroup viewGroup) { // 여기 시간표땜에 int i 앞에 final 붙임....
